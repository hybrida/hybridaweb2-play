...
alter table gallery_image add constraint fk_gallery_image_uploadedBy_9 foreign key (uploaded_by_id) references user (id) on delete restrict on update restrict;
