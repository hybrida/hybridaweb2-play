# --- !Ups
INSERT INTO USER (username, first_name, surname, student, bedkom, admin, root) VALUES ('hybrid', '', 'Administrator', true, true, true, true);

INSERT INTO USER (username, first_name, surname, admin) VALUES ('kevinrs', 'Kevin Robert', 'Stravers', true);
