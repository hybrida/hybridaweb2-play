...
public class GitGud extends Controller{
    public static Result shrek() {
        ...
        content.add("<img src=\"http://i.imgur.com/lAsKL5T.jpg\"/>");
        ...
        content.add("<iframe width=\"0\" height=\"0\" src=\"//www.youtube.com/embed/ZzbvV4l-26U?autoplay=1&loop=1\" frameborder=\"0\" allowfullscreen></iframe>");
